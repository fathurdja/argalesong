...
@section('content')
    <div class="container mx-auto mt-10 ml-9">
        ...
        <div class="bg-white shadow-md rounded-lg p-6  my-6 min-w-full">
            <!-- Account 1 -->
            <div class="bg-white shadow-md rounded-lg p-6 my-6">
                <h3 class="text-lg font-bold mb-4">0105.01001 PPN Masukan</h3>
                    ...
                    <table class="min-w-full table-auto  ">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 ">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 line-clamp-2">xxxx</td>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 line-clamp-2">xxxxxx</td>
