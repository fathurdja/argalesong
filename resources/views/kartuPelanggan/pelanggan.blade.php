...
@section('content')
    <div class="container py-2 px-1 lg:px-4 lg:py-8 mt-14 lg:mt-20">
        <!-- Form Pencarian -->
        <div class="bg-gray-100 p-6 rounded-lg shadow-md mb-6">
            <form method="POST" action="{{ route('kartu-pelanggan-fetchData') }}">
                ...
                <!-- Tombol Cari -->
                <div id="pencarian-pelanggan" class="mt-6 text-right">
                    <button type="submit""
        ...
        <div id="tabel-data" class="bg-white p-4 hidden ">
        ...
        @endsection
        @push('scripts')
        @vite('resources/js/pelanggan.js')
        @endpush
