...
@section('content')
    <div class="container mx-auto bg-white rounded-lg shadow-md m-10 ">
                ...
                <table class="min-w-full table-fixed text-[10px] sm:text-xs md:text-md bg-white border border-gray-300 rounded-lg">
                    <thead>
                        <tr class="bg-gray-200">
                            ...
                            <th class="px-1 py-2  md:px-4 md:py-2 border border-gray-300 w-5">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($riwayatPembayaran as $riwayat)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="px-1 py-2  md:px-4 md:py-2 border border-gray-300 text-blue-500 hover:underline truncate">
                                    <a href="#"><div class="w-3 mx-auto">
