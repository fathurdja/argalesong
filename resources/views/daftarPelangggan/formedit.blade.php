        ...
        <div class="bg-gray-100 w-full px-2 py-1">
            ...
            <div class="flex justify-between items-center mb-4 flex-wrap">
                ...
                <div class="flex justify-end w-full items-end">
                    <a href="{{ route('customer.create') }}" class="bg-green-500 justify-items-end text-white font-bold py-3 px-9 rounded-md">
                        Baru
                    </a>
                </div>
            ...
            <div>
                <h1 class="text-3xl py-3 font-bold">DAFTAR PELANGGAN</h1>
            </div>
            @if (isset($customer))
                ...
                @foreach ($daftarPelanggan as $pelanggan)
                    <div class="bg-white border border-gray-400 p-4 rounded-md mb-5">
                        <div class="flex justify-between items-center border-b border-gray-400 pb-2 mb-2">
                            <h2 class="text-xl font-bold m-5">{{ $pelanggan->id_Pelanggan }}</h2>
                            <h2 class="text-xl font-bold m-5">{{ $pelanggan->name }}</h2>
                            <div class="flex space-x-2 ml-auto">
                                <a href="{{ route('customer.edit', $pelanggan->id) }}" class="p-2 bg-green-700 text-white rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m16.475 5.408l2.117 2.117m-.756-3.982L12.109 9.27a2.1 2.1 0 0 0-.58 1.082L11 13l2.648-.53c.41-.082.786-.283 1.082-.579l5.727-5.727a1.853 1.853 0 1 0-2.621-2.621"/><path d="M19 15v3a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3"/></g>
                                    </svg>
                                </a>                            
