...
@section('content')
    <div class="flex flex-col sm:flex-row justify-center md:justify-evenly items-center bg-gray-300 md:shadow lg:shadow rounded-lg max-w-full md:h-full gap-20 container p-4">
