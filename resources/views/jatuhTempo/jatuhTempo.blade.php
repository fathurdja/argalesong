...
@section('content')
    <div class="container mx-auto mt-20 m-10 p-4 rounded-lg bg-white">
        ...
        <div class="flex items-center mb-4">
            <label for="tahun" class="mr-2 font-semibold text-gray-700">Tahun</label>
            <select id="tahun" name="tahun" class="border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
